...
package Test::Perl::Critic::Enforcer;
...
sub all_policies_ok {
    ...
    for my $enforcer ( sort keys %{$subtests_with_extras} ) {
        ...
        my ($full_enforcer_name, $method) = ("Perl::Critic::Enforcer::$enforcer", 'violates');
...
Test::Perl::Critic::Enforcer - A framework for testing your custom Policies

=head1 SYNOPSIS

    use Test::Perl::Critic::Enforcer qw< all_policies_ok >;
...
L<Perl::Critic::Enforcer|Perl::Critic::Enforcer> modules.  Enforcer testing usually
