package Perl::Critic::Enforcer::ValuesAndExpressions::RequireUpperCaseHeredocTerminator;
...
Perl::Critic::Enforcer::ValuesAndExpressions::RequireUpperCaseHeredocTerminator - Write C< <<'THE_END'; > instead of C< <<'theEnd'; >.
