package Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitConstantPragma;
...
Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitConstantPragma - Don't C<< use constant FOO => 15 >>.
