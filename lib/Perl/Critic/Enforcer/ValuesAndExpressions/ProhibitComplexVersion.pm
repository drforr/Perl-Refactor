...
package Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitComplexVersion;
...
Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitComplexVersion - Prohibit version values from outside the module.
