package Perl::Critic::Enforcer::ValuesAndExpressions::RequireConstantVersion;
...
Perl::Critic::Enforcer::ValuesAndExpressions::RequireConstantVersion - Require $VERSION to be a constant rather than a computed value.
...
L<Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitVersionStrings|Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitVersionStrings>.
