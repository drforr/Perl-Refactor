package Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitMagicNumbers;
...
Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitMagicNumbers - Don't use values that don't explain themselves.
