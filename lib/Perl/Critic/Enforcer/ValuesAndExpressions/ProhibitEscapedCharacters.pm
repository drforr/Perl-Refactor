...
package Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitEscapedCharacters;
...
Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitEscapedCharacters - Write C<"\N{DELETE}"> instead of C<"\x7F">, etc.
