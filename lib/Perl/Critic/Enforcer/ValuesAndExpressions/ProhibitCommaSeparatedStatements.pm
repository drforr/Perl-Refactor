package Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitCommaSeparatedStatements;
...
Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitCommaSeparatedStatements - Don't use the comma operator as a statement separator.
