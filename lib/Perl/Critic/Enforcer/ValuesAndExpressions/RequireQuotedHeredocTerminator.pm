...
package Perl::Critic::Enforcer::ValuesAndExpressions::RequireQuotedHeredocTerminator;
...
Perl::Critic::Enforcer::ValuesAndExpressions::RequireQuotedHeredocTerminator - Write C< print <<'THE_END' > or C< print <<"THE_END" >.
