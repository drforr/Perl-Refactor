package Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitQuotesAsQuotelikeOperatorDelimiters;
...
Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitQuotesAsQuotelikeOperatorDelimiters - Don't use quotes (C<'>, C<">, C<`>) as delimiters for the quote-like operators.
