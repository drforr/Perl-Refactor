package Perl::Critic::Enforcer::Modules::RequireEndWithOne;
...
Perl::Critic::Enforcer::Modules::RequireEndWithOne - End each module with an explicitly C<1;> instead of some funky expression.
...
L<Perl::Critic::Enforcer::Modules::RequireExplicitPackage|Perl::Critic::Enforcer::Modules::RequireExplicitPackage>.
