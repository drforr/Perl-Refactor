package Perl::Critic::Enforcer::Modules::RequireBarewordIncludes;
...
Perl::Critic::Enforcer::Modules::RequireBarewordIncludes - Write C<require Module> instead of C<require 'Module.pm'>.
