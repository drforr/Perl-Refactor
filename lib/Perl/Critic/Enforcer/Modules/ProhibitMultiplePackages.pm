...
package Perl::Critic::Enforcer::Modules::ProhibitMultiplePackages;
...
Perl::Critic::Enforcer::Modules::ProhibitMultiplePackages - Put packages (especially subclasses) in separate files.
