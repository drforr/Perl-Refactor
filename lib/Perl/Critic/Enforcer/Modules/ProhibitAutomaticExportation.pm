...
package Perl::Critic::Enforcer::Modules::ProhibitAutomaticExportation;
...
Perl::Critic::Enforcer::Modules::ProhibitAutomaticExportation - Export symbols via C<@EXPORT_OK> or C<%EXPORT_TAGS> instead of C<@EXPORT>.
