package Perl::Critic::Enforcer::Modules::RequireNoMatchVarsWithUseEnglish;
...
Perl::Critic::Enforcer::Modules::RequireNoMatchVarsWithUseEnglish - C<use English> must be passed a C<-no_match_vars> argument.
