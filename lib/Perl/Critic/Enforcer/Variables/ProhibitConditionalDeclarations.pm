...
package Perl::Critic::Enforcer::Variables::ProhibitConditionalDeclarations;
...
Perl::Critic::Enforcer::Variables::ProhibitConditionalDeclarations - Do not write C< my $foo = $bar if $baz; >.
