...
package Perl::Critic::Enforcer::Variables::RequireLocalizedPunctuationVars;
...
Perl::Critic::Enforcer::Variables::RequireLocalizedPunctuationVars - Magic variables should be assigned as "local".
