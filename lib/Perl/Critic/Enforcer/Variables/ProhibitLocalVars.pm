...
package Perl::Critic::Enforcer::Variables::ProhibitLocalVars;
...
Perl::Critic::Enforcer::Variables::ProhibitLocalVars - Use C<my> instead of C<local>, except when you have to.
