...
package Perl::Critic::Enforcer::Variables::ProhibitPerl4PackageNames;
...
Perl::Critic::Enforcer::Variables::ProhibitPerl4PackageNames - Use double colon (::) to separate package name components instead of single quotes (').
