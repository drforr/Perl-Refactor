package Perl::Critic::Enforcer::Variables::ProtectPrivateVars;
...
Perl::Critic::Enforcer::Variables::ProtectPrivateVars - Prevent access to private vars in other packages.
