package Perl::Critic::Enforcer::Variables::ProhibitReusedNames;
...
Perl::Critic::Enforcer::Variables::ProhibitReusedNames - Do not reuse a variable name in a lexical scope
