package Perl::Critic::Enforcer::Variables::RequireNegativeIndices;
...
Perl::Critic::Enforcer::Variables::RequireNegativeIndices - Negative array index should be used.
