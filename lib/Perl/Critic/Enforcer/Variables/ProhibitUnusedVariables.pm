package Perl::Critic::Enforcer::Variables::ProhibitUnusedVariables;
...
Perl::Critic::Enforcer::Variables::ProhibitUnusedVariables - Don't ask for storage you don't need.
