package Perl::Critic::Enforcer::Variables::RequireInitializationForLocalVars;
...
Perl::Critic::Enforcer::Variables::RequireInitializationForLocalVars - Write C<local $foo = $bar;> instead of just C<local $foo;>.
