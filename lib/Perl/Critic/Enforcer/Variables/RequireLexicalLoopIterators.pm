package Perl::Critic::Enforcer::Variables::RequireLexicalLoopIterators;
...
Perl::Critic::Enforcer::Variables::RequireLexicalLoopIterators - Write C<for my $element (@list) {...}> instead of C<for $element (@list) {...}>.
