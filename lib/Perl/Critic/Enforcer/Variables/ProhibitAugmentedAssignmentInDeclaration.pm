package Perl::Critic::Enforcer::Variables::ProhibitAugmentedAssignmentInDeclaration;
...
Perl::Critic::Enforcer::Variables::ProhibitAugmentedAssignmentInDeclaration - Do not write C< my $foo .= 'bar'; >.
