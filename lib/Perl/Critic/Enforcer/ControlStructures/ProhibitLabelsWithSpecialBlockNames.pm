...
package Perl::Critic::Enforcer::ControlStructures::ProhibitLabelsWithSpecialBlockNames;
...
Perl::Critic::Enforcer::ControlStructures::ProhibitLabelsWithSpecialBlockNames - Don't use labels that are the same as the special block names.
