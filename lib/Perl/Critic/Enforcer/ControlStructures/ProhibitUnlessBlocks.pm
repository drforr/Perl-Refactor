...
package Perl::Critic::Enforcer::ControlStructures::ProhibitUnlessBlocks;
...
Perl::Critic::Enforcer::ControlStructures::ProhibitUnlessBlocks - Write C<if(! $condition)> instead of C<unless($condition)>.
