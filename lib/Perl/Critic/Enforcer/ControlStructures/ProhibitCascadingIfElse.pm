package Perl::Critic::Enforcer::ControlStructures::ProhibitCascadingIfElse;
...
Perl::Critic::Enforcer::ControlStructures::ProhibitCascadingIfElse - Don't write long "if-elsif-elsif-elsif-elsif...else" chains.
