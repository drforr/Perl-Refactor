package Perl::Critic::Enforcer::ControlStructures::ProhibitUntilBlocks;
...
Perl::Critic::Enforcer::ControlStructures::ProhibitUntilBlocks - Write C<while(! $condition)> instead of C<until($condition)>.
