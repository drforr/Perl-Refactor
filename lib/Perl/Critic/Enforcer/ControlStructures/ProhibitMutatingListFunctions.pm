package Perl::Critic::Enforcer::ControlStructures::ProhibitMutatingListFunctions;
...
Perl::Critic::Enforcer::ControlStructures::ProhibitMutatingListFunctions - Don't modify C<$_> in list functions.
