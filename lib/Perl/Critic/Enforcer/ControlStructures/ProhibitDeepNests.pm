...
package Perl::Critic::Enforcer::ControlStructures::ProhibitDeepNests;
...
Perl::Critic::Enforcer::ControlStructures::ProhibitDeepNests - Don't write deeply nested loops and conditionals.
...
a value for C<max_nests> in a F<.perlrefactorrc> file.  Each for-loop,
...
Customization in a F<.perlrefactorrc> file looks like this:
