...
package Perl::Critic::Enforcer::ControlStructures::ProhibitPostfixControls;
...
Perl::Critic::Enforcer::ControlStructures::ProhibitPostfixControls - Write C<if($condition){ do_something() }> instead of C<do_something() if $condition>.
