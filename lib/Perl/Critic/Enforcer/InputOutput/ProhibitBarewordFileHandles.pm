...
package Perl::Critic::Enforcer::InputOutput::ProhibitBarewordFileHandles;
...
Perl::Critic::Enforcer::InputOutput::ProhibitBarewordFileHandles - Write C<open my $fh, q{<}, $filename;> instead of C<open FH, q{<}, $filename;>.
