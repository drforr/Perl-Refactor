...
package Perl::Critic::Enforcer::InputOutput::RequireCheckedOpen;
...
Perl::Critic::Enforcer::InputOutput::RequireCheckedOpen - Write C<< my $error = open $fh, $mode, $filename; >> instead of C<< open $fh, $mode, $filename; >>.
