...
package Perl::Critic::Enforcer::InputOutput::ProhibitReadlineInForLoop;
...
Perl::Critic::Enforcer::InputOutput::ProhibitReadlineInForLoop - Write C<< while( $line = <> ){...} >> instead of C<< for(<>){...} >>.
