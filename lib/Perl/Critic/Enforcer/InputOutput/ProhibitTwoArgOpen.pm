...
package Perl::Critic::Enforcer::InputOutput::ProhibitTwoArgOpen;
...
Perl::Critic::Enforcer::InputOutput::ProhibitTwoArgOpen - Write C<< open $fh, q{<}, $filename; >> instead of C<< open $fh, "<$filename"; >>.
