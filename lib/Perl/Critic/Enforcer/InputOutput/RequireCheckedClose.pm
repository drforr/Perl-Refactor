package Perl::Critic::Enforcer::InputOutput::RequireCheckedClose;
...
Perl::Critic::Enforcer::InputOutput::RequireCheckedClose - Write C<< my $error = close $fh; >> instead of C<< close $fh; >>.
