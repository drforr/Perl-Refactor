...
package Perl::Critic::Enforcer::InputOutput::ProhibitExplicitStdin;
...
Perl::Critic::Enforcer::InputOutput::ProhibitExplicitStdin - Use "<>" or "<ARGV>" or a prompting module instead of "<STDIN>".
