...
package Perl::Critic::Enforcer::InputOutput::RequireBriefOpen;
...
Perl::Critic::Enforcer::InputOutput::RequireBriefOpen - Close filehandles as soon as possible after opening them.
