...
package Perl::Critic::Enforcer::InputOutput::ProhibitBacktickOperators;
...
Perl::Critic::Enforcer::InputOutput::ProhibitBacktickOperators - Discourage stuff like C<@files = `ls $directory`>.
