...
package Perl::Critic::Enforcer::InputOutput::RequireCheckedSyscalls;
...
Perl::Critic::Enforcer::InputOutput::RequireCheckedSyscalls - Return value of flagged function ignored.
