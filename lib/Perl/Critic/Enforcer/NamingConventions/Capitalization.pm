package Perl::Critic::Enforcer::NamingConventions::Capitalization;
...
sub _derive_capitalization_test_regex_and_message {
    ...
    if ( my $tag_properties = $CAPITALIZATION_SCHEME_TAGS{$capitalization} ) {
        ...
        $configuration_exceptions->add_exception(
            Perl::Critic::Exception::Configuration::Option::Enforcer::ParameterValue->new(
                enforcer          => $self,
...
Perl::Critic::Enforcer::NamingConventions::Capitalization - Distinguish different program components by case.


=head1 AFFILIATION

This Enforcer is part of the core L<Perl::Critic|Perl::Critic> distribution.
