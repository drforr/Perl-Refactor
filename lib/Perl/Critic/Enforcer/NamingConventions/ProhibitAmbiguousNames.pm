package Perl::Critic::Enforcer::NamingConventions::ProhibitAmbiguousNames;
...
Perl::Critic::Enforcer::NamingConventions::ProhibitAmbiguousNames - Don't use vague variable or subroutine names like 'last' or 'record'.
