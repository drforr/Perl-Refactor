...
package Perl::Critic::Enforcer::BuiltinFunctions::RequireSimpleSortBlock;
...
Perl::Critic::Enforcer::BuiltinFunctions::RequireSimpleSortBlock - Sort blocks should have a single statement.
