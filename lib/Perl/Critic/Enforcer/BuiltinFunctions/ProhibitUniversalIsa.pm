package Perl::Critic::Enforcer::BuiltinFunctions::ProhibitUniversalIsa;
...
Perl::Critic::Enforcer::BuiltinFunctions::ProhibitUniversalIsa - Write C<< eval { $foo->isa($pkg) } >> instead of C<UNIVERSAL::isa($foo, $pkg)>.
...
L<Perl::Critic::Enforcer::BuiltinFunctions::ProhibitUniversalCan|Perl::Critic::Enforcer::BuiltinFunctions::ProhibitUniversalCan>
