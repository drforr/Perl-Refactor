package Perl::Critic::Enforcer::BuiltinFunctions::ProhibitStringyEval;
...
Perl::Critic::Enforcer::BuiltinFunctions::ProhibitStringyEval - Write C<eval { my $foo; bar($foo) }> instead of C<eval "my $foo; bar($foo);">.


=head1 AFFILIATION

This Enforcer is part of the core L<Perl::Critic|Perl::Critic>
distribution.
...
L<Perl::Critic::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval|Perl::Critic::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval>.

This option inspired by Ricardo SIGNES'
L<Perl::Critic::Enforcer::Lax::ProhibitStringyEval::ExceptForRequire|Perl::Critic::Enforcer::Lax::ProhibitStringyEval::ExceptForRequire>.


=head1 SEE ALSO

L<Perl::Critic::Enforcer::ControlStrucutres::RequireBlockGrep|Perl::Critic::Enforcer::ControlStrucutres::RequireBlockGrep>

L<Perl::Critic::Enforcer::ControlStrucutres::RequireBlockMap|Perl::Critic::Enforcer::ControlStrucutres::RequireBlockMap>
