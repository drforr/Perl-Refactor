package Perl::Critic::Enforcer::BuiltinFunctions::ProhibitStringySplit;
...
Perl::Critic::Enforcer::BuiltinFunctions::ProhibitStringySplit - Write C<split /-/, $string> instead of C<split '-', $string>.
