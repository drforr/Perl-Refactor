package Perl::Critic::Enforcer::BuiltinFunctions::ProhibitBooleanGrep;
...
sub _does_parent_cause_boolean {
    ...
    for (my $node = $parent; $node; $node = $node->parent) { ## no refactor (CStyleForLoop)
...
Perl::Critic::Enforcer::BuiltinFunctions::ProhibitBooleanGrep - Use C<List::MoreUtils::any> instead of C<grep> in boolean context.
