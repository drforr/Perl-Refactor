...
package Perl::Critic::Enforcer::BuiltinFunctions::ProhibitVoidGrep;
...
Perl::Critic::Enforcer::BuiltinFunctions::ProhibitVoidGrep - Don't use C<grep> in void contexts.
