...
package Perl::Critic::Enforcer::BuiltinFunctions::ProhibitLvalueSubstr;
...
Perl::Critic::Enforcer::BuiltinFunctions::ProhibitLvalueSubstr - Use 4-argument C<substr> instead of writing C<substr($foo, 2, 6) = $bar>.
