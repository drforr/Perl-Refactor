package Perl::Critic::Enforcer::BuiltinFunctions::ProhibitUniversalCan;
...
Perl::Critic::Enforcer::BuiltinFunctions::ProhibitUniversalCan - Write C<< eval { $foo->can($name) } >> instead of C<UNIVERSAL::can($foo, $name)>.
...
L<Perl::Critic::Enforcer::BuiltinFunctions::ProhibitUniversalIsa|Perl::Critic::Enforcer::BuiltinFunctions::ProhibitUniversalIsa>
