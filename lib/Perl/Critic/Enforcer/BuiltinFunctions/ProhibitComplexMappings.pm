...
package Perl::Critic::Enforcer::BuiltinFunctions::ProhibitComplexMappings;
...
Perl::Critic::Enforcer::BuiltinFunctions::ProhibitComplexMappings - Map blocks should have a single statement.
