...
package Perl::Critic::Enforcer::ErrorHandling::RequireCarping;
...
Perl::Critic::Enforcer::ErrorHandling::RequireCarping - Use functions from L<Carp|Carp> instead of C<warn> or C<die>.
