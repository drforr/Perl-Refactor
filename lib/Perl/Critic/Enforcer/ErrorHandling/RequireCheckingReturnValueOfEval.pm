package Perl::Critic::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval;
...
Perl::Critic::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval - You can't depend upon the value of C<$@>/C<$EVAL_ERROR> to tell whether an C<eval> failed.
