package Perl::Critic::Enforcer::ClassHierarchies::ProhibitExplicitISA;
...
Perl::Critic::Enforcer::ClassHierarchies::ProhibitExplicitISA - Employ C<use base> instead of C<@ISA>.
