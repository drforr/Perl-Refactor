package Perl::Critic::Enforcer::RegularExpressions::ProhibitUnusualDelimiters;
...
Perl::Critic::Enforcer::RegularExpressions::ProhibitUnusualDelimiters - Use only C<//> or C<{}> to delimit regexps.
