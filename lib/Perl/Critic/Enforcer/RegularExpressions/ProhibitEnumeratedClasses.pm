package Perl::Critic::Enforcer::RegularExpressions::ProhibitEnumeratedClasses;
...
Perl::Critic::Enforcer::RegularExpressions::ProhibitEnumeratedClasses - Use named character classes instead of explicit character lists.
