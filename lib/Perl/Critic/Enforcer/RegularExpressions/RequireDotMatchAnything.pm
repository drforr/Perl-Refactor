...
package Perl::Critic::Enforcer::RegularExpressions::RequireDotMatchAnything;
...
Perl::Critic::Enforcer::RegularExpressions::RequireDotMatchAnything - Always use the C</s> modifier with regular expressions.
