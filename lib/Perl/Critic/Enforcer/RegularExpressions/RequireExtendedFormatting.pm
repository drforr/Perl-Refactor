package Perl::Critic::Enforcer::RegularExpressions::RequireExtendedFormatting;
...
Perl::Critic::Enforcer::RegularExpressions::RequireExtendedFormatting - Always use the C</x> modifier with regular expressions.
