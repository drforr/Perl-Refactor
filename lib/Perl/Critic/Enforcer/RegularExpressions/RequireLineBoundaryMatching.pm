...
package Perl::Critic::Enforcer::RegularExpressions::RequireLineBoundaryMatching;
...
Perl::Critic::Enforcer::RegularExpressions::RequireLineBoundaryMatching - Always use the C</m> modifier with regular expressions.
