package Perl::Critic::Enforcer::RegularExpressions::RequireBracesForMultiline;
...
Perl::Critic::Enforcer::RegularExpressions::RequireBracesForMultiline - Use C<{> and C<}> to delimit multi-line regexps.
