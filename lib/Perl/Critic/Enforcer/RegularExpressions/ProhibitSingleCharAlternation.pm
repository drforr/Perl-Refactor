package Perl::Critic::Enforcer::RegularExpressions::ProhibitSingleCharAlternation;
...
Perl::Critic::Enforcer::RegularExpressions::ProhibitSingleCharAlternation - Use C<[abc]> instead of C<a|b|c>.
