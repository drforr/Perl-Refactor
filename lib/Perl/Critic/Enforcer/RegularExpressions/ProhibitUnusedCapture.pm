...
package Perl::Critic::Enforcer::RegularExpressions::ProhibitUnusedCapture;
...
Perl::Critic::Enforcer::RegularExpressions::ProhibitUnusedCapture - Only use a capturing group if you plan to use the captured value.
