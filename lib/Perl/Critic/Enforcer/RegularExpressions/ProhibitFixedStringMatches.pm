...
package Perl::Critic::Enforcer::RegularExpressions::ProhibitFixedStringMatches;
...
Perl::Critic::Enforcer::RegularExpressions::ProhibitFixedStringMatches - Use C<eq> or hash instead of fixed-pattern regexps.
