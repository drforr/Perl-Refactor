package Perl::Critic::Enforcer::CodeLayout::ProhibitParensWithBuiltins;
...
Perl::Critic::Enforcer::CodeLayout::ProhibitParensWithBuiltins - Write C<open $handle, $path> instead of C<open($handle, $path)>.
