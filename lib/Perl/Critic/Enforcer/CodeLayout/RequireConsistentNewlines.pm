...
package Perl::Critic::Enforcer::CodeLayout::RequireConsistentNewlines;
...
Perl::Critic::Enforcer::CodeLayout::RequireConsistentNewlines - Use the same newline through the source.
