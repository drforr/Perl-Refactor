package Perl::Critic::Enforcer::Documentation::RequirePackageMatchesPodName;
...
Perl::Critic::Enforcer::Documentation::RequirePackageMatchesPodName - The C<=head1 NAME> section should match the package.
