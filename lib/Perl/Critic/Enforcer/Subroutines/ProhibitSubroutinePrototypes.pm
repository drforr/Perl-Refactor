...
package Perl::Critic::Enforcer::Subroutines::ProhibitSubroutinePrototypes;
...
Perl::Critic::Enforcer::Subroutines::ProhibitSubroutinePrototypes - Don't write C<sub my_function (@@) {}>.
