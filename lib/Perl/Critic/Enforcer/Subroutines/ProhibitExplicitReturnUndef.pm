...
package Perl::Critic::Enforcer::Subroutines::ProhibitExplicitReturnUndef;
...
Perl::Critic::Enforcer::Subroutines::ProhibitExplicitReturnUndef - Return failure with bare C<return> instead of C<return undef>.
