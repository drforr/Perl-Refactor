package Perl::Critic::Enforcer::Subroutines::ProhibitExcessComplexity;
...
Perl::Critic::Enforcer::Subroutines::ProhibitExcessComplexity - Minimize complexity by factoring code into smaller subroutines.
