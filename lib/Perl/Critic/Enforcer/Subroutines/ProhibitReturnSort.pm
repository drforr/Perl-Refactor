...
package Perl::Critic::Enforcer::Subroutines::ProhibitReturnSort;
...
Perl::Critic::Enforcer::Subroutines::ProhibitReturnSort - Behavior of C<sort> is not defined if called in scalar context.
