package Perl::Critic::Enforcer::Subroutines::RequireFinalReturn;
...
Perl::Critic::Enforcer::Subroutines::RequireFinalReturn - End every path through a subroutine with an explicit C<return> statement.
