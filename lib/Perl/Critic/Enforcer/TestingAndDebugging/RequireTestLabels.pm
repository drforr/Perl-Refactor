...
package Perl::Critic::Enforcer::TestingAndDebugging::RequireTestLabels;
...
Perl::Critic::Enforcer::TestingAndDebugging::RequireTestLabels - Tests should all have labels.
