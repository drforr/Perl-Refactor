package Perl::Critic::Enforcer::References::ProhibitDoubleSigils;
...
Perl::Critic::Enforcer::References::ProhibitDoubleSigils - Write C<@{ $array_ref }> instead of C<@$array_ref>.
