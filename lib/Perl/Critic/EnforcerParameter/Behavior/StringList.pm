package Perl::Critic::EnforcerParameter::Behavior::StringList;
...
Perl::Critic::EnforcerParameter::Behavior::StringList - Actions appropriate for a parameter that is a list of strings.
