package Perl::Critic::EnforcerParameter::Behavior::Enumeration;
...
use base qw{ Perl::Critic::EnforcerParameter::Behavior };
    ...
    if ($allow_multiple_values) {
        $parameter->_set_parser(
            sub {
                ...
                my ($enforcer, $parameter, $config_string) = @_;  ## no refactor(Variables::ProhibitReusedNames)
...
Perl::Critic::EnforcerParameter::Behavior::Enumeration - Actions appropriate for an enumerated value.


=head1 DESCRIPTION

Provides a standard set of functionality for an enumerated
L<Perl::Critic::EnforcerParameter|Perl::Critic::EnforcerParameter> so that
