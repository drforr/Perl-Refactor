...
use Perl::Critic::Exception::Configuration::Option::Enforcer::ExtraParameter;
use Perl::Critic::Exception::Configuration::Option::Enforcer::ParameterValue;
use Perl::Critic::Exception::Fatal::EnforcerDefinition
    qw< throw_enforcer_definition >;
use Perl::Critic::EnforcerConfig qw<>;
use Perl::Critic::EnforcerParameter qw<>;
...
sub new {
    ...
    if ( $class->can('supported_parameters') ) {
        ...
        @parameters =
            map
                { Perl::Critic::EnforcerParameter->new($_) }
...
sub new_parameter_value_exception {
    ...
    return Perl::Critic::Exception::Configuration::Option::Enforcer::ParameterValue->new(
...
Perl::Critic::Enforcer - Base class for all Enforcer modules.


=head1 DESCRIPTION

Perl::Critic::Enforcer is the abstract base class for all Enforcer
...
L<Perl::Critic::EnforcerConfig|Perl::Critic::EnforcerConfig> as a
...
Create a
L<Perl::Critic::Exception::Configuration::Option::Enforcer::ParameterValue|Perl::Critic::Exception::Configuration::Option::Enforcer::ParameterValue>
for this Enforcer.
...
Return the name of this enforcer without the "Perl::Critic::Enforcer::"
prefix.
...
method returns C<$SEVERITY_LOWEST>.  Authors of Perl::Critic::Enforcer
...
Perl::Critic::Enforcer objects can call this method to assign a
...
L<Perl::Critic::EnforcerParameter|Perl::Critic::EnforcerParameter>.
...
Name of the Enforcer without the C<Perl::Critic::Enforcer::> prefix.
...
string for L<Perl::Critic::EnforcerParameter/"to_formatted_string">.
