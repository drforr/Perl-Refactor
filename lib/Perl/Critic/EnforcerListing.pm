...
package Perl::Critic::EnforcerListing;
...
sub to_string {
    ...
    Perl::Critic::Enforcer::set_format( "%s %p [%t]\n" );
...
Perl::Critic::EnforcerListing - Display minimal information about Policies.
...
Returns a reference to a new C<Perl::Critic::EnforcerListing> object.
...
When a L<Perl::Critic::EnforcerListing|Perl::Critic::EnforcerListing> is
