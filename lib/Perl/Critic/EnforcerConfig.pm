package Perl::Critic::EnforcerConfig;
...
sub handle_extra_parameters {
    ...
    foreach my $offered_param ( $self->get_parameter_names() ) {
        $parameter_errors->add_exception(
            Perl::Critic::Exception::Configuration::Option::Enforcer::ExtraParameter->new(
...
Perl::Critic::EnforcerConfig - Configuration data for a Enforcer.
...
setting.  To be called by Perl::Critic::Enforcer->new() once all valid
