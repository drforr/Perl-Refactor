...
use Perl::Critic::EnforcerParameter::Behavior;
use Perl::Critic::EnforcerParameter::Behavior::Boolean;
use Perl::Critic::EnforcerParameter::Behavior::Enumeration;
use Perl::Critic::EnforcerParameter::Behavior::Integer;
use Perl::Critic::EnforcerParameter::Behavior::String;
use Perl::Critic::EnforcerParameter::Behavior::StringList;
...
Readonly::Hash my %BEHAVIORS =>
    (
        'boolean'     => Perl::Critic::EnforcerParameter::Behavior::Boolean->new(),
        'enumeration' => Perl::Critic::EnforcerParameter::Behavior::Enumeration->new(),
        'integer'     => Perl::Critic::EnforcerParameter::Behavior::Integer->new(),
        'string'      => Perl::Critic::EnforcerParameter::Behavior::String->new(),
        'string list' => Perl::Critic::EnforcerParameter::Behavior::StringList->new(),
    );
...
Perl::Critic::EnforcerParameter - Metadata about a parameter for a Enforcer.
