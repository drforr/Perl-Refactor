package Perl::Critic::Exception::Configuration::NonExistentEnforcer;
...
use Exception::Class (
    'Perl::Critic::Exception::Configuration::NonExistentEnforcer' => {
...
Perl::Critic::Exception::Configuration::NonExistentEnforcer - The configuration referred to a non-existent enforcer.

=head1 DESCRIPTION

A representation of the configuration attempting to specify a
L<Perl::Critic::Enforcer|Perl::Critic::Enforcer> that is not known, whether from a
