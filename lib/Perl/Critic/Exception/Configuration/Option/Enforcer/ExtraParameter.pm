package Perl::Critic::Exception::Configuration::Option::Enforcer::ExtraParameter;
...
use Exception::Class (
    'Perl::Critic::Exception::Configuration::Option::Enforcer::ExtraParameter' => {
...
Perl::Critic::Exception::Configuration::Option::Enforcer::ExtraParameter - The configuration referred to a non-existent parameter for a enforcer.

=head1 DESCRIPTION

A representation of the configuration attempting to specify a value
for a parameter that a L<Perl::Critic::Enforcer|Perl::Critic::Enforcer>
