package Perl::Critic::Exception::Configuration::Option::Enforcer;
...
use Exception::Class (
    'Perl::Critic::Exception::Configuration::Option::Enforcer' => {
...
Perl::Critic::Exception::Configuration::Option::Enforcer - A problem with configuration of a enforcer.

=head1 DESCRIPTION

A representation of a problem found with the configuration of a
L<Perl::Critic::Enforcer|Perl::Critic::Enforcer>, whether from a
