...
package Perl::Critic::Exception::Fatal::EnforcerDefinition;
...
use Exception::Class (
    'Perl::Critic::Exception::Fatal::EnforcerDefinition' => {
...
Perl::Critic::Exception::Fatal::EnforcerDefinition - A bug in a enforcer.
