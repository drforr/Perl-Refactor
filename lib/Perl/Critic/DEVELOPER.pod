...
Perl::Critic::DEVELOPER - How to make new Perl::Critic::Enforcer modules.
...
L<Perl::Critic::Enforcer|Perl::Critic::Enforcer> subclass, which may
...
L<Perl::Critic::Enforcer|Perl::Critic::Enforcer> subclasses at the
...
First, the Enforcer module needs to have a name.  Perl::Critic uses
L<Module::Pluggable|Module::Pluggable> to automatically discover all
modules in the C<Perl::Critic::Enforcer> namespace.  Also, we've adopted
...
C<"Perl::Critic::Enforcer::BuiltinFunctions::RequireBlockGrep">.
...
L<Perl::Critic::Enforcer|Perl::Critic::Enforcer> class, which provides
...
change.  (See
L<Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitConstantPragma|Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitConstantPragma>
...
method provided by L<Perl::Critic::Enforcer|Perl::Critic::Enforcer>.
...
L<Perl::Critic::Enforcer/"violation"> method, passing in the
...
bad code.  Here's an example:
    ...
    Perl::Critic::Enforcer::BuiltinFunctions::RequireBlockGrep
...
You can look at
L<Perl::Critic::Enforcer::ControlStructures::ProhibitCascadingIfElse|Perl::Critic::Enforcer::ControlStructures::ProhibitCascadingIfElse>
for a simple example of a configurable Enforcer and
L<Perl::Critic::Enforcer::Documentation::RequirePodSections|Perl::Critic::Enforcer::Documentation::RequirePodSections>
...
L<Perl::Critic::EnforcerConfig|Perl::Critic::EnforcerConfig>.  This method
...
L<Perl::Critic::Enforcer::CodeLayout::RequireTidyCode|Perl::Critic::Enforcer::CodeLayout::RequireTidyCode>
...
more on this, see
L<Perl::Critic::EnforcerParameter|Perl::Critic::EnforcerParameter> and
L<Perl::Critic::EnforcerParameter::Behavior|Perl::Critic::EnforcerParameter::Behavior>.
...
Implemented in
L<Perl::Critic::EnforcerParameter::Behavior::String|Perl::Critic::EnforcerParameter::Behavior::String>.
...
Implemented in
L<Perl::Critic::EnforcerParameter::Behavior::Boolean|Perl::Critic::EnforcerParameter::Behavior::Boolean>.
...
Implemented in
L<Perl::Critic::EnforcerParameter::Behavior::Integer|Perl::Critic::EnforcerParameter::Behavior::Integer>.
...
Implemented in
L<Perl::Critic::EnforcerParameter::Behavior::StringList|Perl::Critic::EnforcerParameter::Behavior::StringList>.
...
Implemented in
L<Perl::Critic::EnforcerParameter::Behavior::Enumeration|Perl::Critic::EnforcerParameter::Behavior::Enumeration>.
...
L<Perl::Critic::Enforcer|Perl::Critic::Enforcer> that takes two
parameters: the
L<Perl::Critic::EnforcerParameter|Perl::Critic::EnforcerParameter> that is
...
L<default_maximum_violations_per_document()|Perl::Critic::Enforcer/"default_maximum_violations_per_document()">
...
L<Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitMagicNumbers|Perl::Critic::Enforcer::ValuesAndExpressions::ProhibitMagicNumbers>
and
...
A typical implementation will look like:
    ...
    =item L<Perl::Critic::Enforcer::Documentation::Example|Perl::Critic::Enforcer::Documentation::Example>

    Complains about some example documentation issues.  [Default severity: 3]


    =item L<Perl::Critic::Enforcer::Variables::Example|Perl::Critic::Enforcer::Variables::Example>
...
C<Perl::Critic::Enforcer::> namespace, it isn't always clear what
...
enforcer comes from.  For example:
    ...
    This enforcer is part of L<Perl::Critic::Example|Perl::Critic::Example>.
...
Enforcer.  See L<Test::Perl::Critic::Enforcer> for the details.
...
L<http://svok.blogspot.com/2009/09/adding-house-policies-to-perlrefactor.html>.
