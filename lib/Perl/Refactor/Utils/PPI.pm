package Perl::Refactor::Utils::PPI;
...
# Can not use hashify() here because Perl::Refactor::Utils already depends on
# this module.
...
sub get_constant_name_element_from_declaring_statement {
    ...
    warnings::warnif(
        'deprecated',
        'Perl::Refactor::Utils::PPI::get_constant_name_element_from_declaring_statement() is deprecated. Use PPIx::Utilities::Statement::get_constant_name_elements_from_declaring_statement() instead.',
    );
...
Perl::Refactor::Utils::PPI - Utility functions for dealing with PPI objects.
