package Perl::Refactor::Utils::POD;
...
use Perl::Refactor::Exception::IO qw< throw_io >;
...
sub _get_module_abstract_from_filehandle { ## no refactor (RequireFinalReturn)
...
Perl::Refactor::Utils::POD - Utility functions for dealing with POD.


=head1 SYNOPSIS

    use Perl::Refactor::Utils::POD qw< get_pod_section_from_file >;

    my $synopsis =
        get_pod_section_from_file('Perl/Refactor/Utils/POD.pm', 'SYNOPSIS');
    ...
    my $module_abstract =
        get_module_abstract_from_file('Perl/Refactor/Utils/POD.pm');
...
Throws a L<Perl::Refactor::Exception::IO|Perl::Refactor::Exception::IO> if
...
Throws a
L<Perl::Refactor::Exception::Generic|Perl::Refactor::Exception::Generic>
...
L<Perl::Refactor::Exception::Fatal::Generic|Perl::Refactor::Exception::Fatal::Generic>.
