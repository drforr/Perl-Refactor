package Perl::Refactor::Utils::McCabe;
...
use Perl::Refactor::Utils qw{ :data_conversion :classification };
...
sub _count_main_logic_operators_and_keywords {
    ...
    # I can't leverage Perl::Refactor::Document's fast search mechanism here
...
sub _count_logic_keywords {
    ...
    # that I can take advantage of Perl::Refactor::Document's faster
...
Perl::Refactor::Utils::McCabe - Functions that calculate the McCabe score of source code.
