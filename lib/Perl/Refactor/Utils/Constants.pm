package Perl::Refactor::Utils::Constants;
...
use Perl::Refactor::Utils qw{ $EMPTY hashify };
...
# inc/Perl/Refactor/BuildUtilities.pm, sub recommended_module_versions().
...
Perl::Refactor::Utils::Constants - Global constants.


=head1 DESCRIPTION

Defines commonly used constants for L<Perl::Refactor|Perl::Refactor>.
