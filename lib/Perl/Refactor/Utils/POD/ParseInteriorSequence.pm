package Perl::Refactor::Utils::POD::ParseInteriorSequence;
...
Perl::Refactor::Utils::POD::ParseInteriorSequence - Pod::Parser subclass to find all interior sequences.


=head1 SYNOPSIS

    use Perl::Refactor::Utils::POD::ParseInteriorSequence;

    my $parser = Perl::Refactor::Utils::POD::ParseInteriorSequence->new();
...
This module is considered to be private to Perl::Refactor. It can be
