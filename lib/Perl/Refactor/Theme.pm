...
use Perl::Refactor::Utils qw{ :characters :data_conversion };
...
Returns a reference to a new Perl::Refactor::Theme object.  C<-rule> is
...
See L<Perl::Refactor/"CONFIGURATION"> for more information about
