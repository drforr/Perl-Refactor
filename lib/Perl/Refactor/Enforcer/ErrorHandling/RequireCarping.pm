package Perl::Refactor::Enforcer::ErrorHandling::RequireCarping;
...
Perl::Refactor::Enforcer::ErrorHandling::RequireCarping - Use functions from L<Carp|Carp> instead of C<warn> or C<die>.
