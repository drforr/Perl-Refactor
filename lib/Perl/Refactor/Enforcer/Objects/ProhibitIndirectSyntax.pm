package Perl::Refactor::Enforcer::Objects::ProhibitIndirectSyntax;
...
Perl::Refactor::Enforcer::Objects::ProhibitIndirectSyntax - Prohibit indirect object call syntax.
...
Indirect object syntax is also hard for Perl::Refactor to disambiguate, so this
...
L<Perl::Refactor::Enforcer::Dynamic::NoIndirect|Perl::Refactor::Enforcer::Dynamic::NoIndirect>
