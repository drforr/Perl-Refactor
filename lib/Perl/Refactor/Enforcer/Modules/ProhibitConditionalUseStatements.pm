package Perl::Refactor::Enforcer::Modules::ProhibitConditionalUseStatements;
...
Perl::Refactor::Enforcer::Modules::ProhibitConditionalUseStatements - Avoid putting conditional logic around compile-time includes.
