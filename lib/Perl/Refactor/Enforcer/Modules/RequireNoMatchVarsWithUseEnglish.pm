package Perl::Refactor::Enforcer::Modules::RequireNoMatchVarsWithUseEnglish;
...
Perl::Refactor::Enforcer::Modules::RequireNoMatchVarsWithUseEnglish - C<use English> must be passed a C<-no_match_vars> argument.
