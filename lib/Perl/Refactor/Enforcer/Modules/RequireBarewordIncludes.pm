package Perl::Refactor::Enforcer::Modules::RequireBarewordIncludes;
...
Perl::Refactor::Enforcer::Modules::RequireBarewordIncludes - Write C<require Module> instead of C<require 'Module.pm'>.
...
(L<Perl::Refactor|Perl::Refactor> is an example of this).  In that case,
