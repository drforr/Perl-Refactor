package Perl::Refactor::Enforcer::Modules::ProhibitMultiplePackages;
...
Perl::Refactor::Enforcer::Modules::ProhibitMultiplePackages - Put packages (especially subclasses) in separate files.
