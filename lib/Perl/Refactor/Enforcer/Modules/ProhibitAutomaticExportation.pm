package Perl::Refactor::Enforcer::Modules::ProhibitAutomaticExportation;
...
Perl::Refactor::Enforcer::Modules::ProhibitAutomaticExportation - Export symbols via C<@EXPORT_OK> or C<%EXPORT_TAGS> instead of C<@EXPORT>.
