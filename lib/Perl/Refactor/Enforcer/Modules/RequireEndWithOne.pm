package Perl::Refactor::Enforcer::Modules::RequireEndWithOne;
...
Perl::Refactor::Enforcer::Modules::RequireEndWithOne - End each module with an explicitly C<1;> instead of some funky expression.
...
L<Perl::Refactor::Enforcer::Modules::RequireExplicitPackage|Perl::Refactor::Enforcer::Modules::RequireExplicitPackage>.
