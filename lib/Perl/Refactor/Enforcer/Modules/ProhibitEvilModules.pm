package Perl::Refactor::Enforcer::Modules::ProhibitEvilModules;
...
Perl::Refactor::Enforcer::Modules::ProhibitEvilModules - Ban modules that aren't blessed by your shop.
