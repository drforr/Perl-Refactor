package Perl::Refactor::Enforcer::Modules::RequireExplicitPackage;
...
use Perl::Refactor::Utils qw{ :booleans :severities :classification };
...
Perl::Refactor::Enforcer::Modules::RequireExplicitPackage - Always make the C<package> explicit.
