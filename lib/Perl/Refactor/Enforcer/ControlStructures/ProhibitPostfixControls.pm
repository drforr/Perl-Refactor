package Perl::Refactor::Enforcer::ControlStructures::ProhibitPostfixControls;
...
use Perl::Refactor::Utils qw{ :characters :severities :data_conversion :classification };
...
Perl::Refactor::Enforcer::ControlStructures::ProhibitPostfixControls - Write C<if($condition){ do_something() }> instead of C<do_something() if $condition>.
