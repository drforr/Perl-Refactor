package Perl::Refactor::Enforcer::ControlStructures::ProhibitNegativeExpressionsInUnlessAndUntilConditions;
...
use Perl::Refactor::Utils qw< :characters :severities :classification hashify >;
...
Perl::Refactor::Enforcer::ControlStructures::ProhibitNegativeExpressionsInUnlessAndUntilConditions - Don't use operators like C<not>, C<!~>, and C<le> within C<until> and C<unless>.
...
L<Perl::Refactor::Enforcer::ControlStructures::ProhibitUnlessBlocks|Perl::Refactor::Enforcer::ControlStructures::ProhibitUnlessBlocks>
