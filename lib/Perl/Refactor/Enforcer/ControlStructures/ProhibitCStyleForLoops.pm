package Perl::Refactor::Enforcer::ControlStructures::ProhibitCStyleForLoops;
...
Perl::Refactor::Enforcer::ControlStructures::ProhibitCStyleForLoops - Write C<for(0..20)> instead of C<for($i=0; $i<=20; $i++)>.
