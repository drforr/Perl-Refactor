package Perl::Refactor::Enforcer::ControlStructures::ProhibitUntilBlocks;
...
Perl::Refactor::Enforcer::ControlStructures::ProhibitUntilBlocks - Write C<while(! $condition)> instead of C<until($condition)>.
