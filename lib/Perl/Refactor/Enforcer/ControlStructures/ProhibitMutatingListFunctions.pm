package Perl::Refactor::Enforcer::ControlStructures::ProhibitMutatingListFunctions;
...
Perl::Refactor::Enforcer::ControlStructures::ProhibitMutatingListFunctions - Don't modify C<$_> in list functions.
