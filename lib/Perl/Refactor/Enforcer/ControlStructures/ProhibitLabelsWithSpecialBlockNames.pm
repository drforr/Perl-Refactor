package Perl::Refactor::Enforcer::ControlStructures::ProhibitLabelsWithSpecialBlockNames;
...
use Perl::Refactor::Utils qw{ :severities hashify };
...
Perl::Refactor::Enforcer::ControlStructures::ProhibitLabelsWithSpecialBlockNames - Don't use labels that are the same as the special block names.
