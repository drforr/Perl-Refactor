package Perl::Refactor::Enforcer::ClassHierarchies::ProhibitOneArgBless;
...
use Perl::Refactor::Utils qw{ :booleans :severities :classification :ppi };
...
Perl::Refactor::Enforcer::ClassHierarchies::ProhibitOneArgBless - Write C<bless {}, $class;> instead of just C<bless {};>.
