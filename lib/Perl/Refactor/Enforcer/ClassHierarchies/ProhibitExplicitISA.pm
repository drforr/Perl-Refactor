package Perl::Refactor::Enforcer::ClassHierarchies::ProhibitExplicitISA;
...
Perl::Refactor::Enforcer::ClassHierarchies::ProhibitExplicitISA - Employ C<use base> instead of C<@ISA>.
