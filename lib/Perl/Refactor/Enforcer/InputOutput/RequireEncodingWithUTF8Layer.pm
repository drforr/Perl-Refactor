package Perl::Refactor::Enforcer::InputOutput::RequireEncodingWithUTF8Layer;
...
use Perl::Refactor::Utils qw{ :severities :ppi };
...
Perl::Refactor::Enforcer::InputOutput::RequireEncodingWithUTF8Layer - Write C<< open $fh, q{<:encoding(UTF-8)}, $filename; >> instead of C<< open $fh, q{{<:utf8}, $filename; >>.
...
Because C<Perl::Refactor> does a static analysis, this enforcer can not
detect cases like
