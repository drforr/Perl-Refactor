package Perl::Refactor::Enforcer::InputOutput::RequireCheckedOpen;
...
Perl::Refactor::Enforcer::InputOutput::RequireCheckedOpen - Write C<< my $error = open $fh, $mode, $filename; >> instead of C<< open $fh, $mode, $filename; >>.
