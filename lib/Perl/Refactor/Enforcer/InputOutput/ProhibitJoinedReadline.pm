package Perl::Refactor::Enforcer::InputOutput::ProhibitJoinedReadline;
...
use Perl::Refactor::Utils qw{ :severities :classification parse_arg_list };
...
Perl::Refactor::Enforcer::InputOutput::ProhibitJoinedReadline - Use C<local $/ = undef> or L<File::Slurp|File::Slurp> instead of joined readline.
