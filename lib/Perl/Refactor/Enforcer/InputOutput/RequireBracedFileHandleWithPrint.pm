package Perl::Refactor::Enforcer::InputOutput::RequireBracedFileHandleWithPrint;
...
use Perl::Refactor::Utils qw{ :severities :classification :data_conversion };
...
Perl::Refactor::Enforcer::InputOutput::RequireBracedFileHandleWithPrint - Write C<print {$FH} $foo, $bar;> instead of C<print $FH $foo, $bar;>.
