package Perl::Refactor::Enforcer::InputOutput::RequireBriefOpen;
...
use Perl::Refactor::Utils qw{ :severities :classification :booleans
...
Perl::Refactor::Enforcer::InputOutput::RequireBriefOpen - Close filehandles as soon as possible after opening them.
