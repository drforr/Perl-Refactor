package Perl::Refactor::Enforcer::InputOutput::RequireCheckedClose;
...
Perl::Refactor::Enforcer::InputOutput::RequireCheckedClose - Write C<< my $error = close $fh; >> instead of C<< close $fh; >>.
