package Perl::Refactor::Enforcer::InputOutput::ProhibitReadlineInForLoop;
...
Perl::Refactor::Enforcer::InputOutput::ProhibitReadlineInForLoop - Write C<< while( $line = <> ){...} >> instead of C<< for(<>){...} >>.
