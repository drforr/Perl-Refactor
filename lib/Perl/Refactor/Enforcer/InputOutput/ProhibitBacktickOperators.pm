package Perl::Refactor::Enforcer::InputOutput::ProhibitBacktickOperators;
...
use Perl::Refactor::Utils qw{ :severities is_in_void_context };
...
Perl::Refactor::Enforcer::InputOutput::ProhibitBacktickOperators - Discourage stuff like C<@files = `ls $directory`>.
