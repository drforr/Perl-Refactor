package Perl::Refactor::Enforcer::InputOutput::ProhibitTwoArgOpen;
...
Perl::Refactor::Enforcer::InputOutput::ProhibitTwoArgOpen - Write C<< open $fh, q{<}, $filename; >> instead of C<< open $fh, "<$filename"; >>.
