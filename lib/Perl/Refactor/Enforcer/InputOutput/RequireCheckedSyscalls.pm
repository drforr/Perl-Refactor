package Perl::Refactor::Enforcer::InputOutput::RequireCheckedSyscalls;
...
Perl::Refactor::Enforcer::InputOutput::RequireCheckedSyscalls - Return value of flagged function ignored.
