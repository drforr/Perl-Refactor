package Perl::Refactor::Enforcer::InputOutput::ProhibitExplicitStdin;
...
Perl::Refactor::Enforcer::InputOutput::ProhibitExplicitStdin - Use "<>" or "<ARGV>" or a prompting module instead of "<STDIN>".
