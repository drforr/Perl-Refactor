package Perl::Refactor::Enforcer::ValuesAndExpressions::RequireUpperCaseHeredocTerminator;
...
Perl::Refactor::Enforcer::ValuesAndExpressions::RequireUpperCaseHeredocTerminator - Write C< <<'THE_END'; > instead of C< <<'theEnd'; >.
