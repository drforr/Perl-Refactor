package Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitInterpolationOfLiterals;
...
use Perl::Refactor::Utils qw{ :characters :severities :data_conversion };
...
Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitInterpolationOfLiterals - Always use single quotes for literal strings.
...
those strings are literal, Perl::Refactor will complain.  To prevent
...
L<Perl::Refactor::Enforcer::ValuesAndExpressions::RequireInterpolationOfMetachars|Perl::Refactor::Enforcer::ValuesAndExpressions::RequireInterpolationOfMetachars>
