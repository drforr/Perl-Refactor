package Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitEscapedCharacters;
...
Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitEscapedCharacters - Write C<"\N{DELETE}"> instead of C<"\x7F">, etc.
