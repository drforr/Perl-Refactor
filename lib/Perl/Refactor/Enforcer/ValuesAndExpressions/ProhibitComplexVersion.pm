package Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitComplexVersion;
...
Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitComplexVersion - Prohibit version values from outside the module.
