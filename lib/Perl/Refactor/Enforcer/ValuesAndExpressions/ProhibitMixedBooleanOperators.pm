package Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitMixedBooleanOperators;
...
Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitMixedBooleanOperators - Write C< !$foo && $bar || $baz > instead of C< not $foo && $bar or $baz>.
