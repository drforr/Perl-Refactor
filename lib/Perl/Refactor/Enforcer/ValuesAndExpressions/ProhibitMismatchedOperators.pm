package Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitMismatchedOperators;
use 5.006001;
use strict;
use warnings;
use Readonly;

use Perl::Refactor::Utils qw{ :booleans :severities };
...
Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitMismatchedOperators - Don't mix numeric operators with string operands, or vice-versa.
