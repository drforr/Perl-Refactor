package Perl::Refactor::Enforcer::ValuesAndExpressions::RequireConstantVersion;
...
sub violates {
    ...
    return $value if $value->isa( 'Perl::Refactor::Exception' );
...
# Perl::Refactor::Exception to be returned.
...
Perl::Refactor::Enforcer::ValuesAndExpressions::RequireConstantVersion - Require $VERSION to be a constant rather than a computed value.
...
L<Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitVersionStrings|Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitVersionStrings>.
