package Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitMagicNumbers;
...
use Perl::Refactor::Utils qw{ :booleans :characters :severities :data_conversion };
...
Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitMagicNumbers - Don't use values that don't explain themselves.
