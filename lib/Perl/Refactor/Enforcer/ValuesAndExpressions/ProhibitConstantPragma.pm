package Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitConstantPragma;
...
Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitConstantPragma - Don't C<< use constant FOO => 15 >>.
