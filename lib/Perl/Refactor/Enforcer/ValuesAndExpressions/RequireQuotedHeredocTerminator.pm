package Perl::Refactor::Enforcer::ValuesAndExpressions::RequireQuotedHeredocTerminator;
...
Perl::Refactor::Enforcer::ValuesAndExpressions::RequireQuotedHeredocTerminator - Write C< print <<'THE_END' > or C< print <<"THE_END" >.
