package Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitCommaSeparatedStatements;
...
use Perl::Refactor::Utils qw{ :booleans :characters :severities :classification };
use Perl::Refactor::Utils::PPI qw{ is_ppi_statement_subclass };
...
Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitCommaSeparatedStatements - Don't use the comma operator as a statement separator.
