package Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitQuotesAsQuotelikeOperatorDelimiters;
...
Perl::Refactor::Enforcer::ValuesAndExpressions::ProhibitQuotesAsQuotelikeOperatorDelimiters - Don't use quotes (C<'>, C<">, C<`>) as delimiters for the quote-like operators.
