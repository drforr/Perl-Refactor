package Perl::Refactor::Enforcer::CodeLayout::ProhibitQuotedWordLists;
...
Perl::Refactor::Enforcer::CodeLayout::ProhibitQuotedWordLists - Write C<qw(foo bar baz)> instead of C<('foo', 'bar', 'baz')>.
