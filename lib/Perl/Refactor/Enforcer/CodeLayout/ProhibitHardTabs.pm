package Perl::Refactor::Enforcer::CodeLayout::ProhibitHardTabs;
...
Perl::Refactor::Enforcer::CodeLayout::ProhibitHardTabs - Use spaces instead of tabs.
...
Beware that Perl::Refactor may report the location of the string that
