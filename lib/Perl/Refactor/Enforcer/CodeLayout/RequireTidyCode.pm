package Perl::Refactor::Enforcer::CodeLayout::RequireTidyCode;
...
sub violates {
    ...
    ## no refactor (ProhibitComplexRegexes)
...
Perl::Refactor::Enforcer::CodeLayout::RequireTidyCode - Must run code through L<perltidy|perltidy>.
...
Perl::Refactor can be told to tell Perl::Tidy to use a specific
