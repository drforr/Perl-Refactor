package Perl::Refactor::Enforcer::CodeLayout::RequireConsistentNewlines;
...
Perl::Refactor::Enforcer::CodeLayout::RequireConsistentNewlines - Use the same newline through the source.
