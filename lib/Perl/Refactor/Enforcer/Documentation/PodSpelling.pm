package Perl::Refactor::Enforcer::Documentation::PodSpelling;
...
sub _run_spell_command {
    ...
    eval {
        ...
        or do {
            ...
            if (
                    $EVAL_ERROR
                and not ref Perl::Refactor::Exception::Fatal::Generic->caught()
            ) {
...
Perl::Refactor::Enforcer::Documentation::PodSpelling - Check your spelling.
...
Ideally, we'd like Perl::Refactor to tell you when your documentation is
...
A spell checking program is not included with Perl::Refactor.
