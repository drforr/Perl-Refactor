package Perl::Refactor::Enforcer::Documentation::RequirePackageMatchesPodName;
...
Perl::Refactor::Enforcer::Documentation::RequirePackageMatchesPodName - The C<=head1 NAME> section should match the package.
