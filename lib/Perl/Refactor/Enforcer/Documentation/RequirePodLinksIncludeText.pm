package Perl::Refactor::Enforcer::Documentation::RequirePodLinksIncludeText;
...
Perl::Refactor::Enforcer::Documentation::RequirePodLinksIncludeText - Provide text to display with your pod links.
