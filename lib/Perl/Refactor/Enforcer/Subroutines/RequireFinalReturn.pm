package Perl::Refactor::Enforcer::Subroutines::RequireFinalReturn;
...
Perl::Refactor::Enforcer::Subroutines::RequireFinalReturn - End every path through a subroutine with an explicit C<return> statement.
...
or C<exit>, then you can configure Perl::Refactor to recognize those
