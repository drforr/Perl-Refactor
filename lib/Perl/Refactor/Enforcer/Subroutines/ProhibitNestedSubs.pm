package Perl::Refactor::Enforcer::Subroutines::ProhibitNestedSubs;
...
Perl::Refactor::Enforcer::Subroutines::ProhibitNestedSubs - C<sub never { sub correct {} }>.
...
Originally part of L<Perl::Refactor::Tics|Perl::Refactor::Tics>.
