package Perl::Refactor::Enforcer::Subroutines::ProhibitUnusedPrivateSubroutines;
...
Perl::Refactor::Enforcer::Subroutines::ProhibitUnusedPrivateSubroutines - Prevent unused private subroutines.
...
a double underscore are not considered to be private.  (Perl::Refactor,
...
other Perl::Refactor modules, but not by anything outside of
Perl::Refactor.)
...
L<Perl::Refactor::Enforcer::Subroutines::ProtectPrivateSubs|Perl::Refactor::Enforcer::Subroutines::ProtectPrivateSubs>,
