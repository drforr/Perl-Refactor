package Perl::Refactor::Enforcer::Subroutines::ProhibitSubroutinePrototypes;
...
Perl::Refactor::Enforcer::Subroutines::ProhibitSubroutinePrototypes - Don't write C<sub my_function (@@) {}>.
