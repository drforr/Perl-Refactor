package Perl::Refactor::Enforcer::Subroutines::ProhibitBuiltinHomonyms;
...
Perl::Refactor::Enforcer::Subroutines::ProhibitBuiltinHomonyms - Don't declare your own C<open> function.
...
each other.  However, at this time, Perl::Refactor cannot tell whether a
