package Perl::Refactor::Enforcer::Subroutines::ProhibitExplicitReturnUndef;
...
Perl::Refactor::Enforcer::Subroutines::ProhibitExplicitReturnUndef - Return failure with bare C<return> instead of C<return undef>.
