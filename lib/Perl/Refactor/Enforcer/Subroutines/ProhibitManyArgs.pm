package Perl::Refactor::Enforcer::Subroutines::ProhibitManyArgs;
...
use Perl::Refactor::Utils qw{ :booleans :severities split_nodes_on_comma };
...
Perl::Refactor::Enforcer::Subroutines::ProhibitManyArgs - Too many arguments.
