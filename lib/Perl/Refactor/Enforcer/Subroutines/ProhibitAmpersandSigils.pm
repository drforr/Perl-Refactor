package Perl::Refactor::Enforcer::Subroutines::ProhibitAmpersandSigils;
...
Perl::Refactor::Enforcer::Subroutines::ProhibitAmpersandSigils - Don't call functions with a leading ampersand sigil.
