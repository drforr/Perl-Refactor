package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitUniversalCan;
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitUniversalCan - Write C<< eval { $foo->can($name) } >> instead of C<UNIVERSAL::can($foo, $name)>.
...
L<Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitUniversalIsa|Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitUniversalIsa>
