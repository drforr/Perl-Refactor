package Perl::Refactor::Enforcer::BuiltinFunctions::RequireSimpleSortBlock;
...
Perl::Refactor::Enforcer::BuiltinFunctions::RequireSimpleSortBlock - Sort blocks should have a single statement.
