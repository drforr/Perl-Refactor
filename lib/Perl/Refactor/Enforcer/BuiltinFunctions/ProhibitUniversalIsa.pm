package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitUniversalIsa;
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitUniversalIsa - Write C<< eval { $foo->isa($pkg) } >> instead of C<UNIVERSAL::isa($foo, $pkg)>.
...
L<Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitUniversalCan|Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitUniversalCan>
