package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitLvalueSubstr;
...
use Perl::Refactor::Utils qw{ :severities :classification :language };
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitLvalueSubstr - Use 4-argument C<substr> instead of writing C<substr($foo, 2, 6) = $bar>.
