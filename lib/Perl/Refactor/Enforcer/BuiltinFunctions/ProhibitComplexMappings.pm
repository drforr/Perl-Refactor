package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitComplexMappings;
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitComplexMappings - Map blocks should have a single statement.
