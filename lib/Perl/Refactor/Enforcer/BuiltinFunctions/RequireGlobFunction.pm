package Perl::Refactor::Enforcer::BuiltinFunctions::RequireGlobFunction;
...
Perl::Refactor::Enforcer::BuiltinFunctions::RequireGlobFunction - Use C<glob q{*}> instead of <*>.
