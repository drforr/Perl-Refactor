package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitVoidMap;
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitVoidMap - Don't use C<map> in void contexts.
