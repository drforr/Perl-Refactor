package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitStringySplit;
...
use Perl::Refactor::Utils qw{ :characters :severities :classification :ppi };
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitStringySplit - Write C<split /-/, $string> instead of C<split '-', $string>.
...
behavior, so Perl::Refactor forgives that usage.  See C<"perldoc -f
