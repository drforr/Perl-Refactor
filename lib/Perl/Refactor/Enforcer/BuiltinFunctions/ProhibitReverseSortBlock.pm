package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitReverseSortBlock;
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitReverseSortBlock - Forbid $b before $a in sort blocks.
