package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitSleepViaSelect;
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitSleepViaSelect - Use L<Time::HiRes|Time::HiRes> instead of something like C<select(undef, undef, undef, .05)>.
