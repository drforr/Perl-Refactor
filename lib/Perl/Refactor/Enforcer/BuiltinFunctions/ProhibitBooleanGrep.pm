package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitBooleanGrep;
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitBooleanGrep - Use C<List::MoreUtils::any> instead of C<grep> in boolean context.
