...
Perl::Refactor::Enforcer::BuiltinFunctions::RequireBlockGrep - Write C<grep { $_ =~ /$pattern/ } @list> instead of C<grep /$pattern/, @list>.
...
L<Perl::Refactor::Enforcer::BuiltinFunctions::RequireBlockMap|Perl::Refactor::Enforcer::BuiltinFunctions::RequireBlockMap>
