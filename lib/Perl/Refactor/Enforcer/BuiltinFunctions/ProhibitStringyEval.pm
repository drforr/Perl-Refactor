package Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitStringyEval;
...
use Perl::Refactor::Utils qw{ :booleans :severities :classification :ppi $SCOLON };
...
Perl::Refactor::Enforcer::BuiltinFunctions::ProhibitStringyEval - Write C<eval { my $foo; bar($foo) }> instead of C<eval "my $foo; bar($foo);">.
...
L<Perl::Refactor::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval|Perl::Refactor::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval>.

This option inspired by Ricardo SIGNES'
L<Perl::Refactor::Enforcer::Lax::ProhibitStringyEval::ExceptForRequire|Perl::Refactor::Enforcer::Lax::ProhibitStringyEval::ExceptForRequire>.


=head1 SEE ALSO

L<Perl::Refactor::Enforcer::ControlStrucutres::RequireBlockGrep|Perl::Refactor::Enforcer::ControlStrucutres::RequireBlockGrep>

L<Perl::Refactor::Enforcer::ControlStrucutres::RequireBlockMap|Perl::Refactor::Enforcer::ControlStrucutres::RequireBlockMap>
