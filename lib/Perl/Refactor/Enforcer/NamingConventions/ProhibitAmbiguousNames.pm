package Perl::Refactor::Enforcer::NamingConventions::ProhibitAmbiguousNames;
...
Perl::Refactor::Enforcer::NamingConventions::ProhibitAmbiguousNames - Don't use vague variable or subroutine names like 'last' or 'record'.
