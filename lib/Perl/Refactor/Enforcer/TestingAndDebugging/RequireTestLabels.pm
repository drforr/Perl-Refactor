package Perl::Refactor::Enforcer::TestingAndDebugging::RequireTestLabels;
...
sub _has_test_more {
    ...
    # search for method calls.  Since Perl::Refactor::Document is
...
Perl::Refactor::Enforcer::TestingAndDebugging::RequireTestLabels - Tests should all have labels.
