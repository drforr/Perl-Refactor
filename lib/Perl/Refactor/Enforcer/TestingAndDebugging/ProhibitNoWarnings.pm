package Perl::Refactor::Enforcer::TestingAndDebugging::ProhibitNoWarnings;
...
Perl::Refactor::Enforcer::TestingAndDebugging::ProhibitNoWarnings - Prohibit various flavors of C<no warnings>.
