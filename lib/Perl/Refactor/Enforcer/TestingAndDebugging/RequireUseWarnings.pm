package Perl::Refactor::Enforcer::TestingAndDebugging::RequireUseWarnings;
...
use Perl::Refactor::Utils qw{ :severities $EMPTY };
...
#-----------------------------------------------------------------------------
# Here, we're using the fact that Perl::Refactor::Document::find() is optimized
...
Perl::Refactor::Enforcer::TestingAndDebugging::RequireUseWarnings - Always C<use warnings>.
...
L<Perl::Refactor::Enforcer::TestingAndDebugging::ProhibitNoWarnings|Perl::Refactor::Enforcer::TestingAndDebugging::ProhibitNoWarnings>
