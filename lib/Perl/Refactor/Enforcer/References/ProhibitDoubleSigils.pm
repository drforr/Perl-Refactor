package Perl::Refactor::Enforcer::References::ProhibitDoubleSigils;
...
Perl::Refactor::Enforcer::References::ProhibitDoubleSigils - Write C<@{ $array_ref }> instead of C<@$array_ref>.
