package Perl::Refactor::Enforcer::RegularExpressions::RequireExtendedFormatting;
...
Perl::Refactor::Enforcer::RegularExpressions::RequireExtendedFormatting - Always use the C</x> modifier with regular expressions.
