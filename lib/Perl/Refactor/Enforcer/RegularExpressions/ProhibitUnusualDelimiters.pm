package Perl::Refactor::Enforcer::RegularExpressions::ProhibitUnusualDelimiters;
...
Perl::Refactor::Enforcer::RegularExpressions::ProhibitUnusualDelimiters - Use only C<//> or C<{}> to delimit regexps.
