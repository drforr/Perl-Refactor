package Perl::Refactor::Enforcer::RegularExpressions::ProhibitCaptureWithoutTest;
...
use Perl::Refactor::Utils qw{ :booleans :data_conversion :severities };
...
Perl::Refactor::Enforcer::RegularExpressions::ProhibitCaptureWithoutTest - Capture variable used outside conditional.
