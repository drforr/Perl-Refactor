package Perl::Refactor::Enforcer::RegularExpressions::RequireBracesForMultiline;
...
Perl::Refactor::Enforcer::RegularExpressions::RequireBracesForMultiline - Use C<{> and C<}> to delimit multi-line regexps.
