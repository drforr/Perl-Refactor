package Perl::Refactor::Enforcer::RegularExpressions::ProhibitUnusedCapture;
...
#           '!~' operator;
#       document => a reference to the Perl::Refactor::Document;
...
Perl::Refactor::Enforcer::RegularExpressions::ProhibitUnusedCapture - Only use a capturing group if you plan to use the captured value.
