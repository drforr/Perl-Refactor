package Perl::Refactor::Enforcer::RegularExpressions::RequireLineBoundaryMatching;
...
Perl::Refactor::Enforcer::RegularExpressions::RequireLineBoundaryMatching - Always use the C</m> modifier with regular expressions.
