package Perl::Refactor::Enforcer::RegularExpressions::ProhibitFixedStringMatches;
...
Perl::Refactor::Enforcer::RegularExpressions::ProhibitFixedStringMatches - Use C<eq> or hash instead of fixed-pattern regexps.
