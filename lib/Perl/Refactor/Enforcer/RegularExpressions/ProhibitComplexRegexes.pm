package Perl::Refactor::Enforcer::RegularExpressions::ProhibitComplexRegexes;
...
Perl::Refactor::Enforcer::RegularExpressions::ProhibitComplexRegexes - Split long regexps into smaller C<qr//> chunks.
