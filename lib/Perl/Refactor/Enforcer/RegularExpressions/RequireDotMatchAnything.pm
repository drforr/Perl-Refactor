package Perl::Refactor::Enforcer::RegularExpressions::RequireDotMatchAnything;
...
Perl::Refactor::Enforcer::RegularExpressions::RequireDotMatchAnything - Always use the C</s> modifier with regular expressions.
