package Perl::Refactor::Enforcer::RegularExpressions::ProhibitSingleCharAlternation;
...
Perl::Refactor::Enforcer::RegularExpressions::ProhibitSingleCharAlternation - Use C<[abc]> instead of C<a|b|c>.
