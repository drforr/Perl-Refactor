package Perl::Refactor::Enforcer::Variables::RequireInitializationForLocalVars;
...
Perl::Refactor::Enforcer::Variables::RequireInitializationForLocalVars - Write C<local $foo = $bar;> instead of just C<local $foo;>.
