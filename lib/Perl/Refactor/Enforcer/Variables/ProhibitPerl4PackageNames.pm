package Perl::Refactor::Enforcer::Variables::ProhibitPerl4PackageNames;
...
use Perl::Refactor::Utils qw{ :characters :severities :classification };
...
Perl::Refactor::Enforcer::Variables::ProhibitPerl4PackageNames - Use double colon (::) to separate package name components instead of single quotes (').
