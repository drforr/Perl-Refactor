package Perl::Refactor::Enforcer::Variables::ProhibitReusedNames;
...
Perl::Refactor::Enforcer::Variables::ProhibitReusedNames - Do not reuse a variable name in a lexical scope
