package Perl::Refactor::Enforcer::Variables::ProhibitConditionalDeclarations;
...
Perl::Refactor::Enforcer::Variables::ProhibitConditionalDeclarations - Do not write C< my $foo = $bar if $baz; >.
