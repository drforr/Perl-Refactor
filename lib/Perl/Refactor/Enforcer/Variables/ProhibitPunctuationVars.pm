package Perl::Refactor::Enforcer::Variables::ProhibitPunctuationVars;
...
sub _create_magic_detector {
    ...
    # way Perl::Refactor handles testing.
    #
...
Perl::Refactor::Enforcer::Variables::ProhibitPunctuationVars - Write C<$EVAL_ERROR> instead of C<$@>.
