package Perl::Refactor::Enforcer::Variables::RequireNegativeIndices;
...
Perl::Refactor::Enforcer::Variables::RequireNegativeIndices - Negative array index should be used.
