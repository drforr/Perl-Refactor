package Perl::Refactor::Enforcer::Variables::ProtectPrivateVars;
...
Perl::Refactor::Enforcer::Variables::ProtectPrivateVars - Prevent access to private vars in other packages.
