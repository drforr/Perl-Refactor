package Perl::Refactor::Enforcer::Variables::ProhibitAugmentedAssignmentInDeclaration;
...
Perl::Refactor::Enforcer::Variables::ProhibitAugmentedAssignmentInDeclaration - Do not write C< my $foo .= 'bar'; >.
