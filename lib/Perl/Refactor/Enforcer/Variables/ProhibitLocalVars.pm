package Perl::Refactor::Enforcer::Variables::ProhibitLocalVars;
...
Perl::Refactor::Enforcer::Variables::ProhibitLocalVars - Use C<my> instead of C<local>, except when you have to.
...
Perl::Refactor will not complain if you C<local>-ize variables with a
