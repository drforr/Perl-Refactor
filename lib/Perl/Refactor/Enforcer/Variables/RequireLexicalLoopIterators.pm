package Perl::Refactor::Enforcer::Variables::RequireLexicalLoopIterators;
...
Perl::Refactor::Enforcer::Variables::RequireLexicalLoopIterators - Write C<for my $element (@list) {...}> instead of C<for $element (@list) {...}>.
