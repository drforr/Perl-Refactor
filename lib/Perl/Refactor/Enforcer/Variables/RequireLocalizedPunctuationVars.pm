package Perl::Refactor::Enforcer::Variables::RequireLocalizedPunctuationVars;
...
use Perl::Refactor::Utils qw{ :severities :classification $EMPTY hashify};
...
Perl::Refactor::Enforcer::Variables::RequireLocalizedPunctuationVars - Magic variables should be assigned as "local".
