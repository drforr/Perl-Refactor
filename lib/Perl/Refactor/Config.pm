...
sub _init {
    ...
    my $profile = Perl::Refactor::UserProfile->new( -profile => $profile_source );
    ...
    my $factory =
        Perl::Refactor::EnforcerFactory->new(
            -profile              => $profile,
            -errors               => $errors,
...
sub _new_global_value_exception {
    ...
    return
        Perl::Refactor::Exception::Configuration::Option::Global::ParameterValue
            ->new(@args);
}
...
sub _validate_and_save_theme {
    ...
    if ( $theme_rule =~ m/$RULE_INVALID_CHARACTER_REGEX/xms ) {
        ...
        if ($EVAL_ERROR) {
            ...
            eval {
                $self->{_theme} =
                    Perl::Refactor::Theme->new( -rule => $theme_rule );
            }
                or do {
...
sub _validate_and_save_color_severity {
    ...
    # values anyway for the benefit of Perl::Refactor::ProfilePrototype.
...
sub site_enforcer_names {
    return Perl::Refactor::EnforcerFactory::site_enforcer_names();
}
...
Perl::Refactor::Config - The final derived Perl::Refactor configuration, combined from any profile file and command-line parameters.


=head1 DESCRIPTION

Perl::Refactor::Config takes care of finding and processing
user-preferences for L<Perl::Refactor|Perl::Refactor>.  The Config object
defines which Enforcer modules will be loaded into the Perl::Refactor
engine and how they should be configured.  You should never really
need to instantiate Perl::Refactor::Config directly because the
Perl::Refactor constructor will do it for you.
...
Returns the L<Perl::Refactor::Theme|Perl::Refactor::Theme> object that was
...
Perl::Refactor::Config has a few static subroutines that are used
...
L<Perl::Refactor::Config|Perl::Refactor::Config> will look for this file
...
corresponding Perl::Refactor constructor argument.
...
Perl::Refactor::Config constructor.
...
L<Perl::Refactor::OptionsProcessor|Perl::Refactor::OptionsProcessor>,
