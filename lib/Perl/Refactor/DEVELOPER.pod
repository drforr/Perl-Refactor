...
Policies that ship with Perl::Refactor have a C<"core"> theme.  Since
...
Most L<Perl::Refactor> Policies are purely I<static>.  In other words,
...
add-on policies are generally named C<Perl::Refactor::I<something>>,
...
A typical implementation will look like:
    ...
    Perl::Refactor::Example - Policies for Perl::Refactor that act as an example.
    ...
    Some L<Perl::Refactor|Perl::Refactor> policies that will help you keep your
