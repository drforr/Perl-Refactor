package Perl::Refactor::EnforcerListing;
...
sub to_string {
    ...
    Perl::Refactor::Enforcer::set_format( "%s %p [%t]\n" );

    return join q{}, map { "$_" } @{ $self->{_enforcers} };
}
...
Returns a reference to a new C<Perl::Refactor::EnforcerListing> object.
...
When a L<Perl::Refactor::EnforcerListing|Perl::Refactor::EnforcerListing> is
