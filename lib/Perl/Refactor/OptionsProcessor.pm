package Perl::Refactor::OptionsProcessor;
...
use Perl::Refactor::Exception::Configuration::Option::Global::ExtraParameter;
...
sub _init {
    ...
    $self->{_single_enforcer}   = dor(delete $args{'single-enforcer'},    $EMPTY);
    ...
    my $default_color = ($self->pager() or not -t *STDOUT) ? $FALSE : $TRUE; ## no refactor (ProhibitInteractiveTest)
    ...
    if ( my @remaining = sort keys %args ){
        ...
        foreach my $option_name (@remaining) {
            $errors->add_exception(
                Perl::Refactor::Exception::Configuration::Option::Global::ExtraParameter->new(
...
Perl::Refactor::OptionsProcessor - The global configuration default values, combined with command-line values.


=head1 DESCRIPTION

This is a helper class that encapsulates the default parameters for
constructing a L<Perl::Refactor::Config|Perl::Refactor::Config> object.
...
Returns a reference to a new C<Perl::Refactor::OptionsProcessor> object.
...
onto by
L<Perl::Refactor::EnforcerParameter|Perl::Refactor::EnforcerParameter>.  there
...
Returns the default C<single-enforcer> pattern.  (As a string.)
...
L<Perl::Refactor::Config|Perl::Refactor::Config>,
