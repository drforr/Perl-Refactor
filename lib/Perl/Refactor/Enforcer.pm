package Perl::Refactor::Enforcer;
...
use Perl::Refactor::Utils::POD qw<
...
use Perl::Refactor::Exception::Configuration::Option::Enforcer::ExtraParameter;
...
use Perl::Refactor::EnforcerConfig qw<>;
use Perl::Refactor::EnforcerParameter qw<>;
use Perl::Refactor::Violation qw<>;
...
sub new {
    ...
    if ( $class->can('supported_parameters') ) {
        ...
        @parameters =
            map
                { Perl::Refactor::EnforcerParameter->new($_) }
                $class->supported_parameters();
    }
    $self->{_parameter_metadata_available} = $parameter_metadata_available;
    $self->{_parameters} = \@parameters;

    my $errors = Perl::Refactor::Exception::AggregateConfiguration->new();
...
sub violation {  ## no refactor (ArgUnpacking)
    my ( $self, $desc, $expl, $elem ) = @_;
    # HACK!! Use goto instead of an explicit call because P::C::V::new() uses caller()
    my $sev = $self->get_severity();
    @_ = ('Perl::Refactor::Violation', $desc, $expl, $elem, $sev );
    goto &Perl::Refactor::Violation::new;
}
...
sub new_parameter_value_exception {
    ...
    return Perl::Refactor::Exception::Configuration::Option::Enforcer::ParameterValue->new(
...
sub set_format { return $format = $_[0] }  ## no refactor(ArgUnpacking)
...
Perl::Refactor::Enforcer - Base class for all Enforcer modules.
...
L<Perl::Refactor::DEVELOPER|Perl::Refactor::DEVELOPER> document included
...
L<developer|Perl::Refactor::DEVELOPER> documentation for more.


=item C<< initialize_if_enabled( $config ) >>

This receives an instance of
L<Perl::Refactor::EnforcerConfig|Perl::Refactor::EnforcerConfig> as a
...
L<Perl::Refactor::Violation|Perl::Refactor::Violation> objects if the
...
Returns a reference to a new C<Perl::Refactor::Violation> object. The
...
L<Perl::Refactor::Violation|Perl::Refactor::Violation>, but without the
...
Return the name of this enforcer without the "Perl::Refactor::Enforcer::"
prefix.
...
C<$SEVERITY> constants in L<Perl::Refactor::Utils|Perl::Refactor::Utils>
for an enumeration of possible severity values.  By default, this
method returns C<$SEVERITY_LOWEST>.  Authors of Perl::Refactor::Enforcer
...
L<Perl::Refactor::Utils|Perl::Refactor::Utils> for an enumeration of
...
Perl::Refactor::Enforcer objects can call this method to assign a
...
By default L<Perl::Refactor|Perl::Refactor> will not run unsafe enforcers.
...
L<Perl::Refactor::Violation|Perl::Refactor::Violation>, it will try and
extract the DESCRIPTION section of your Enforcer module's POD.  This
information is displayed by Perl::Refactor if the verbosity level is set
...
Perl::Refactor::Violation overloads the C<""> operator to produce neat
...
Name of the Enforcer without the C<Perl::Refactor::Enforcer::> prefix.
...
string for L<Perl::Refactor::EnforcerParameter/"to_formatted_string">.
