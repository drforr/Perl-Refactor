package Perl::Refactor::EnforcerParameter;
...
use Perl::Refactor::EnforcerParameter::Behavior;
use Perl::Refactor::EnforcerParameter::Behavior::Boolean;
use Perl::Refactor::EnforcerParameter::Behavior::Enumeration;
use Perl::Refactor::EnforcerParameter::Behavior::Integer;
use Perl::Refactor::EnforcerParameter::Behavior::String;
use Perl::Refactor::EnforcerParameter::Behavior::StringList;

use Perl::Refactor::Utils qw{ :characters &interpolate };
use Perl::Refactor::Utils::DataConversion qw{ &defined_or_empty };
...
Readonly::Hash my %BEHAVIORS =>
    (
        'boolean'     => Perl::Refactor::EnforcerParameter::Behavior::Boolean->new(),
        'enumeration' => Perl::Refactor::EnforcerParameter::Behavior::Enumeration->new(),
        'integer'     => Perl::Refactor::EnforcerParameter::Behavior::Integer->new(),
        'string'      => Perl::Refactor::EnforcerParameter::Behavior::String->new(),
        'string list' => Perl::Refactor::EnforcerParameter::Behavior::StringList->new(),
    );
...
Perl::Refactor::EnforcerParameter - Metadata about a parameter for a Enforcer.
...
L<Perl::Refactor::DEVELOPER/"MAKING YOUR POLICY CONFIGURABLE">
