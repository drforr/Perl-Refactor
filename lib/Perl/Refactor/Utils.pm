...
use Perl::Refactor::Utils::PPI qw< is_ppi_expression_or_generic_statement >;
...
Readonly::Scalar our $POLICY_NAMESPACE => 'Perl::Refactor::Enforcer';
...
sub is_script {
    ...
    warnings::warnif(
        'deprecated',
        'Perl::Refactor::Utils::is_script($doc) deprecated, use $doc->is_program() instead.',  ## no refactor (ValuesAndExpressions::RequireInterpolationOfMetachars)
    );

    return $doc->is_program()
        if blessed($doc) && $doc->isa('Perl::Refactor::Document');
...
sub all_perl_files {
    ...
    # poached from Test::Perl::Refactor.
...
# subroutine was also poached from Test::Perl::Refactor
...
Perl::Refactor::Utils - General utility subroutines and constants for Perl::Refactor and derivative distributions.


=head1 DESCRIPTION

This module provides several static subs and variables that are useful
for developing L<Perl::Refactor::Enforcer|Perl::Refactor::Enforcer>
...
should use the L<Perl::Refactor::Document/"is_program()"> method instead.
...
L<Perl::Refactor::Violation|Perl::Refactor::Violation>.  See the
...
L<Perl::Refactor::Enforcer|Perl::Refactor::Enforcer>.  The C<get_severity> and
...
parameters to a C<use Perl::Refactor::Util> statement.
...
See also L<Perl::Refactor::Utils::PPI|Perl::Refactor::Utils::PPI>.
...
L<Perl::Refactor::Utils::Constants|Perl::Refactor::Utils::Constants>,
L<Perl::Refactor::Utils::McCabe|Perl::Refactor::Utils::McCabe>,
L<Perl::Refactor::Utils::PPI|Perl::Refactor::Utils::PPI>,
