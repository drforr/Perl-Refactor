package Perl::Refactor::Document;
...
use Perl::Refactor::Exception::Parse qw< throw_parse >;
use Perl::Refactor::Utils qw< :booleans :characters shebang_line >;
...
sub _init_from_external_source { ## no refactor (Subroutines::RequireArgUnpacking)
    ...
    if (@_ == 1) {
        warnings::warnif(
            'deprecated',
            'Perl::Refactor::Document->new($source) deprecated, use Perl::Refactor::Document->new(-source => $source) instead.' ## no refactor (ValuesAndExpressions::RequireInterpolationOfMetachars)
        );
        %args = ('-source' => shift);
    } else {
        %args = @_;
...
sub find {
    ...
    # once per Perl::Refactor::Document instance.  %elements of will be
...
# This got hung on the Perl::Refactor::Document, rather than living in
# Perl::Refactor::Utils::PPI, because of the possibility that caching of scope
...
sub process_annotations {
    ...
    my @annotations = Perl::Refactor::Annotation->create_annotations($self);
...
Perl::Refactor::Document - Caching wrapper around a PPI::Document.
...
=head1 SYNOPSIS
    ...
    $doc = Perl::Refactor::Document->new(-source => $doc);
    ## Then use the instance just like a PPI::Document


=head1 DESCRIPTION

Perl::Refactor does a lot of iterations over the PPI document tree via
...
L<Perl::Refactor::Document|Perl::Refactor::Document> will not have a filename.
This may cause L<Perl::Refactor::Document|Perl::Refactor::Document> to incorrectly
...
L<Perl::Refactor::Document|Perl::Refactor::Document> to have a particular
...
Perl::Refactor's subsequent analysis because some caches may fall out of
date.
...
this method will return two L<Perl::Refactor::Document|Perl::Refactor::Document>s
...
PPI::Document, the Perl::Refactor::Document class masquerades as the
PPI::Document class.
...
L<Perl::Refactor::Annotation|Perl::Refactor::Annotation>s that
...
L<Perl::Refactor::Violation|Perl::Refactor::Violation>s
