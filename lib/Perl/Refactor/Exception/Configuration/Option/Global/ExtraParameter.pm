package Perl::Refactor::Exception::Configuration::Option::Global::ExtraParameter;
...
use Exception::Class (
    'Perl::Refactor::Exception::Configuration::Option::Global::ExtraParameter' => {
        isa         => 'Perl::Refactor::Exception::Configuration::Option::Global',
...
Perl::Refactor::Exception::Configuration::Option::Global::ExtraParameter - The configuration referred to a non-existent global option.

=head1 DESCRIPTION

A representation of the configuration attempting to specify a value
for an option that L<Perl::Refactor|Perl::Refactor> doesn't have, whether
from a F<.perlrefactorrc>, another profile file, or command line.
