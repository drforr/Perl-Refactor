package Perl::Refactor::Exception::Configuration::Option::Global::ParameterValue;
...
Perl::Refactor::Exception::Configuration::Option::Global::ParameterValue - A problem with the value of a global parameter.
