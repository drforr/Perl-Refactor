package Perl::Refactor::Exception::Configuration::Option::Enforcer::ParameterValue;
...
use Exception::Class (
    'Perl::Refactor::Exception::Configuration::Option::Enforcer::ParameterValue' => {
...
Perl::Refactor::Exception::Configuration::Option::Enforcer::ParameterValue - A problem with the value of a parameter for a enforcer.

=head1 DESCRIPTION

A representation of a problem found with the value of a parameter for
a L<Perl::Refactor::Enforcer|Perl::Refactor::Enforcer>, whether from a
