package Perl::Refactor::Exception::Fatal;
...
use Exception::Class (
    'Perl::Refactor::Exception::Fatal' => {
        isa         => 'Perl::Refactor::Exception',
        description =>
            'A problem that should cause Perl::Refactor to stop running.',
    },
);
...
Perl::Refactor::Exception::Fatal - A problem that should cause L<Perl::Refactor|Perl::Refactor> to stop running.
