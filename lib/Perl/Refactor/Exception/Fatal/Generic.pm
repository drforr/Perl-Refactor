package Perl::Refactor::Exception::Fatal::Generic;
...
use Exception::Class (
    'Perl::Refactor::Exception::Fatal::Generic' => {
...
Perl::Refactor::Exception::Fatal::Generic - A problem for which there is no specialized information.
