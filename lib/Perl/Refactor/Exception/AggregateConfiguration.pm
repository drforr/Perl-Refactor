package Perl::Refactor::Exception::AggregateConfiguration;
...
sub add_exception_or_rethrow {
    ...
    if ( $eval_error->isa('Perl::Refactor::Exception::Configuration') ) {
        $self->add_exception($eval_error);
    }
    elsif (
        $eval_error->isa('Perl::Refactor::Exception::AggregateConfiguration')
    ) {
        $self->add_exceptions_from($eval_error);
    }
    else {
        die $eval_error; ## no refactor (RequireCarping)
    }
...
Perl::Refactor::Exception::AggregateConfiguration - A collection of a set of problems found in the configuration and/or command-line options.
...
L<Perl::Refactor::Exception::Configuration|Perl::Refactor::Exception::Configuration>
or
L<Perl::Refactor::Exception::AggregateConfiguration|Perl::Refactor::Exception::AggregateConfiguration>,
