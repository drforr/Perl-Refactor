package Perl::Refactor::EnforcerParameter::Behavior::Enumeration;
...
Perl::Refactor::EnforcerParameter::Behavior::Enumeration - Actions appropriate for an enumerated value.
