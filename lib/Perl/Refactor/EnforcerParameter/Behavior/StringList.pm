package Perl::Refactor::EnforcerParameter::Behavior::StringList;

use 5.006001;
use strict;
use warnings;

use Perl::Refactor::Utils qw{ :characters &words_from_string &hashify };
...
Perl::Refactor::EnforcerParameter::Behavior::StringList - Actions appropriate for a parameter that is a list of strings.
