package Perl::Refactor::EnforcerParameter::Behavior::String;
...
Perl::Refactor::EnforcerParameter::Behavior::String - Actions appropriate for a simple string parameter.
