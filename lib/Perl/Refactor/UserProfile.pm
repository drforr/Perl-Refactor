package Perl::Refactor::UserProfile;
...
use Perl::Refactor::OptionsProcessor qw();
use Perl::Refactor::Utils qw{ :characters enforcer_long_name enforcer_short_name };
use Perl::Refactor::Exception::Fatal::Internal qw{ throw_internal };
use Perl::Refactor::Exception::Configuration::Generic qw{ throw_generic };
...
sub enforcer_params {
    ...
    return Perl::Refactor::EnforcerConfig->new(
        $short_name,
...
sub _set_options_processor {
    ...
    $self->{_options_processor} =
        Perl::Refactor::OptionsProcessor->new( %{ $defaults } );
    return $self;
}
...
Perl::Refactor::UserProfile - The contents of the user's profile, often F<.perlrefactorrc>.
...
L<Perl::Refactor::Config|Perl::Refactor::Config> does that.
...
Given a reference to a L<Perl::Refactor::Enforcer|Perl::Refactor::Enforcer>
...
L<Perl::Refactor::EnforcerConfig|Perl::Refactor::EnforcerConfig> for the
