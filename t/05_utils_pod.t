...
{
    my $code = q<my $x = 3;>;  ## no refactor (RequireInterpolationOfMetachars)
...
END_MODULE
    ...
    my $expected = q<An abstract involving C<$code>.>; ## no refactor (RequireInterpolationOfMetachars)
    ...
    $expected = q<An abstract involving `$code'.>; ## no refactor (RequireInterpolationOfMetachars)
