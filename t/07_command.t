...
$message = "@ARGV";
%options = Perl::Refactor::Command::_get_options();
...
$message = "@ARGV";
%options = eval { Perl::Refactor::Command::_get_options() };
...

{
    ...
    local *Perl::Refactor::Command::pod2usage =
        sub { my %args = @_; confess $args{-message} || q{} };

    local @ARGV = qw( -help );
    eval { Perl::Refactor::Command::_get_options() };
