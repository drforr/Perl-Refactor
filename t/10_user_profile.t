...

{
    ...
    my $up = Perl::Refactor::UserProfile->new( -profile => \%profile_hash );
    ...
    is(
        $up->enforcer_is_enabled('Perl::Refactor::Enforcer::CodeLayout::ProhibitQuotedWordLists'),
        1,
        'Perl::Refactor::Enforcer::CodeLayout::ProhibitQuotedWordLists is enabled.',
    );
    is(
        $up->enforcer_is_disabled('Perl::Refactor::Enforcer::NamingConventions::Capitalization'),
        1,
        'Perl::Refactor::Enforcer::NamingConventions::Capitalization is disabled.',
    );
    is_deeply(
        $up->raw_enforcer_params('Perl::Refactor::Enforcer::CodeLayout::ProhibitQuotedWordLists'),
        \%enforcer_params,
        'Perl::Refactor::Enforcer::CodeLayout::ProhibitQuotedWordLists got the correct configuration.',
    );

    # Using bogus enforcer names
    is(
        $up->enforcer_is_enabled('Perl::Refactor::Enforcer::Bogus'),
        q{},
        q<Bogus Enforcer isn't enabled>,
    );
    is(
        $up->enforcer_is_disabled('Perl::Refactor::Enforcer::Bogus'),
        q{},
        q<Bogus Enforcer isn't disabled>,
    );
    is_deeply(
        $up->raw_enforcer_params('Perl::Refactor::Enforcer::Bogus'),
        {},
...

{
    ...
    my $up = Perl::Refactor::UserProfile->new( -profile => \@profile_array );
...
END_PROFILE
    ...
    my $up = Perl::Refactor::UserProfile->new( -profile => \$profile_string );
...
[-Perl::Refactor::Enforcer::NamingConventions::Capitalization]
[Perl::Refactor::Enforcer::CodeLayout::ProhibitQuotedWordLists]
min_elements = 4
END_PROFILE

    my $up = Perl::Refactor::UserProfile->new( -profile => \$long_profile_string );
...

{
    ...
    eval { Perl::Refactor::UserProfile->new( -profile => $code_ref ) };
    like(
        $EVAL_ERROR,
    ...
    eval { Perl::Refactor::UserProfile->new( -profile => 'bogus' ) };
    like(
        $EVAL_ERROR,
    ...
    eval { Perl::Refactor::UserProfile->new( -profile => \$invalid_syntax ) };
    like(
        $EVAL_ERROR,
...

{
    ...
    my $got = Perl::Refactor::UserProfile::_find_profile_path();
