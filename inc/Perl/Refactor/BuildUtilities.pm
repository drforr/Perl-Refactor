package Perl::Refactor::BuildUtilities;
...
sub recommended_module_versions {
    return (
        ...
        # in $Perl::Refactor::Utils::Constants::_MODULE_VERSION_TERM_ANSICOLOR.
        'Term::ANSIColor'       => '2.02',
...
extracted the Perl::Refactor tarball using GNU tar.
...
Perl::Refactor::BuildUtilities - Common bits of compiling Perl::Refactor.


=head1 DESCRIPTION

Various utilities used in assembling Perl::Refactor, primary for use by
...
for Perl::Refactor and the minimum version required of each module,
